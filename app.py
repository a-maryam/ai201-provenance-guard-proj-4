...
def get_transparency_label(score: float) -> str:
    ...
    if score >= 0.40:
        return "Our analysis returned mixed signals; this content may be AI-assisted or human-written. If this is your own work, you can submit an appeal."
    return "This content appears to have been written by a human."


def score_confidence(llm_score: float, style_score: float) -> float:
    """LLM weighted at 0.65, stylometry at 0.35 — semantic signal is more reliable than structural heuristics."""
    return round((llm_score * 0.65) + (style_score * 0.35), 4)
